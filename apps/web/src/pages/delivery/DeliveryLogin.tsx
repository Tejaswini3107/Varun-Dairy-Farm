    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ marginTop: 28, padding: 14, background: "var(--surface-2)", borderRadius: 12, fontSize: 12 }}>
          ...
          {[
            { name: "Sanjay Kumar", phone: "9100000001", route: "Route 3 · Kondapur" },
            { name: "Amit Mishra", phone: "9100000002", route: "Route 5 · Gachibowli" },
            { name: "Deepak R", phone: "9100000003", route: "Route 1 · Jubilee Hills" },
          ].map(u => (
            <div key={u.phone} onClick={() => { setPhone(u.phone); setStep("phone"); }}
              ...
              <span style={{ color: "var(--muted)", marginLeft: 8 }}>{u.route}</span>
            </div>
          ))}
        </div>
      </div>
